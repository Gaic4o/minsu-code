...
export class ChannelsController {
    ...
    @ApiOperation({ summary: '모든 채널 가져오기'})
    @Get(':url/channels') 
    ...
    @ApiOperation({ summary: '특정 채널 가져오기'})
    ...
    @ApiOperation({ summary: '채널 멤버 가져오기'})
    ...
    @ApiOperation({ summary: '채널 멤버 초대하기'})
    ...
    @ApiOperation({ summary: '워크스페이스 특정 채널 채팅 모두 다 가져오기' })
